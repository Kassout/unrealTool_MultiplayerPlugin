...
{
	// If Blaster is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Blaster.Build.cs is not automatically propagated
